...
parser = argparse.ArgumentParser(description="RainbowHash&Crack is Great Tool for recover Hashe.It Supports Hash such as md5, sha1, sha256, sha512, and many more. It is alsocapable of genrate Rainbow Table with Wordlist file as input.")
...
if len(sys.argv) < 2:
    ...
    while True:
        ...
        if (inp == 'help') or (inp == '?'):
            ...
            print('     Example : File /root/RainbowHash&Crack/pass')
